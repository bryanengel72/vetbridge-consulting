...
const Hero: React.FC = () => {
  return (
    <div className="relative min-h-screen bg-navy flex items-center pt-20 overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-blue-500/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/4"></div>
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-orange-500/10 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/4"></div>
        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20 mix-blend-overlay"></div>
      </div>

      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
        <div className="reveal">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-accent-orange text-xs font-bold uppercase tracking-widest mb-8">
          ...
          <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.9] mb-8">
            Smarter <br />
            <span className="text-accent-orange italic font-serif">Operations</span> <br />
            for Modern Vets.
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <a href="https://calendar.app.google/ki8q1DDtziZjLvRz5" target="_blank" rel="noopener noreferrer" className="group bg-accent-orange text-navy px-10 py-5 rounded-2xl font-black text-lg hover:bg-white transition-all shadow-2xl shadow-orange-500/20 flex items-center justify-center gap-2">
        ...
        <div className="hidden lg:block relative reveal" style={{ transitionDelay: '0.2s' }}>
          <div className="relative z-10 animate-float">
            <div className="bg-gradient-to-br from-slate-800 to-navy rounded-[3rem] p-3 shadow-2xl border border-white/10 backdrop-blur-xl">
            ...
            {/* Decorative Badges */}
            <div className="absolute -bottom-10 -right-10 bg-accent-orange p-8 rounded-3xl shadow-3xl text-navy rotate-6 transform hover:rotate-0 transition-transform cursor-pointer">
