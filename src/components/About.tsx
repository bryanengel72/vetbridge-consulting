    ...
    <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
      ...
      <div className="reveal mt-12 lg:mt-0" style={{ transitionDelay: '0.2s' }}>
        ...
        <div className="grid sm:grid-cols-2 gap-8">
          <div className="group">
            <div className="w-12 h-12 bg-brand-primary text-white rounded-xl flex items-center justify-center mb-4 group-hover:bg-brand-accent group-hover:text-brand-primary transition-colors duration-300">
