            ...
            <div className="relative w-full h-full card-flip preserve-3d cursor-default">
              ...
              <div className="absolute inset-0 backface-hidden bg-white p-10 rounded-[2.5rem] shadow-lg border border-slate-100 flex flex-col overflow-hidden">
                ...
                <div className="mt-auto pt-8 border-t border-slate-50 flex items-center justify-between">
                  ...
                  <div className="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-slate-300 group-hover:bg-accent-orange group-hover:text-navy transition-colors duration-500">
              ...
              <div className="absolute inset-0 backface-hidden rotate-y-180 bg-navy p-8 rounded-[2.5rem] shadow-2xl flex flex-col border border-white/10">
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h4 className="text-accent-orange font-black text-[10px] uppercase tracking-[0.2em]">The Challenge</h4>
                  </div>
                ...
                <div className="mt-auto">
                  <a href="https://calendar.app.google/ki8q1DDtziZjLvRz5" target="_blank" rel="noopener noreferrer" className="w-full bg-white text-navy py-4 rounded-xl font-black text-center text-xs block hover:bg-accent-orange transition-all uppercase tracking-widest">
