...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative selection:bg-orange-100 selection:text-orange-900">
      ...
      <main className="flex-grow">
        ...
        <section id="testimonials" className="py-24 bg-white relative">
          <div className="absolute top-1/2 left-0 w-64 h-64 bg-accent-orange/5 rounded-full blur-[100px] -translate-y-1/2"></div>
          <Testimonials />
        </section>
